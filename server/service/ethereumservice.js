...
const EthereumService = {
  ...
  test() {
    let customSigner = this.getSigner('0xc876c481add221e551f6420bc1e6be6a3b28004691a279ea8613fc54a031db25');
    /*
    this.contract.balanceOf('0xeDDf29Fa1fb8ADcbaCF1Ef3691604Bdb65341Ac6').then((data)=>{
      console.log(data);
    });
    */

    this.contract = new ethers.Contract(this.EPIPHANY_CONTRACT, TokenABI, customSigner);
    //this.contract.balanceOf(wallet.address).then((data)=>{console.log(data[0].toString())});
   this.provider.getGasPrice().then((data)=>{
     console.log(utils.formatEther(data.toString()));
   });
